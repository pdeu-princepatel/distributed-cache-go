...
const (
	PhoneType_PHONE_TYPR_UNSPECIFIED PhoneType = 0
	PhoneType_PHONE_TYPE_MOBLIE      PhoneType = 1
...
var (
	PhoneType_name = map[int32]string{
		0: "PHONE_TYPR_UNSPECIFIED",
		1: "PHONE_TYPE_MOBLIE",
		2: "PHONE_TYPE_HOME",
		3: "PHONE_TYPE_WORK",
	}
	PhoneType_value = map[string]int32{
		"PHONE_TYPR_UNSPECIFIED": 0,
		"PHONE_TYPE_MOBLIE":      1,
		"PHONE_TYPE_HOME":        2,
		"PHONE_TYPE_WORK":        3,
	}
...
func (x *Person_PhoneNumber) GetType() PhoneType {
	...
	return PhoneType_PHONE_TYPR_UNSPECIFIED
}
...
const file_addressbook_proto_rawDesc = "" +
	...
	"\tPhoneType\x12\x1a\n" +
	"\x16PHONE_TYPR_UNSPECIFIED\x10\x00\x12\x15\n" +
	"\x11PHONE_TYPE_MOBLIE\x10\x01\x12\x13\n" +
